...
const Button = ({ buttonText, classButton, handleClick, icon, classIcon, classInfo, classInfoText, infoText, showEl, txtShow1, txtShow2, src, alt, classImg, path, classLink }) => {
  return (
    <>
